...
def bbox_iou(box1, box2, x1y1x2y2=True, GIoU=False, DIoU=False, CIoU=False, SIoU=False, EIoU=False, eps=1e-7):
    ...
    if GIoU or DIoU or CIoU or SIoU or EIoU:
        ...
        if SIoU:
            s_cw = (b2_x1 + b2_x2 - b1_x2 - b1_x2) * 0.5
            s_ch = (b2_y1 + b2_y2 - b1_y2 - b1_y2) * 0.5
...
def bbox_alpha_iou(box1, box2, x1y1x2y2=False, GIoU=False, DIoU=False, CIoU=False, SIoU=False, alpha=2, eps=1e-9):
...
def non_max_suppression(prediction, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic=False, multi_label=False,
    ...
    for xi, x in enumerate(prediction):  # image index, image inference
        ...
        #i = Self_Soft_NMS(boxes, scores, iou_thres, False, False, False, 0, 0.5, 0.01) #Soft-diou_NMS
